...
- [x] Construir a nova imagem Docker Distroless e nomeá-la como fake-shop-distroless.
...
Como etapa final, segue o repositório da imagem Docker, contendo todos os requisitos propostos: [fake-shop-security](https://hub.docker.com/repository/docker/diego64/fake-shop-security/general)
